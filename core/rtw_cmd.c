...
//		printk(__FILE__ ":%s 1 cmdcode=%x \n", __func__, (int) pcmd->cmdcode);			// --- AP ---
...
//		if(pcmd->cmdcode == 0x38)							// --- AP ---
//			printk(__FILE__ ":%s 2 cmdcode=%x \n", __func__, (int) pcmd->cmdcode);			// --- AP ---

//		printk(__FILE__ ":%s 3 cmd_hdl=%x \n", __func__, (int) cmd_hdl);			// --- AP ---
