...
void rtw_signal_stat_timer_hdl(RTW_TIMER_HDL_ARGS);
#else //4.15
void rtw_signal_stat_timer_hdl(struct timer_list *t);                                                   // --- AP ---
#endif // 4.15
//-------------------------------------------------------------
...
//---------------------------------------------------------------------
	...
	rtw_init_timer(&precvpriv->signal_stat_timer, padapter, RTW_TIMER_HDL_NAME(signal_stat));
#else // 4.15
	timer_setup(&precvpriv->signal_stat_timer , rtw_signal_stat_timer_hdl, 0 );                                     // --- AP ---
#endif // 4.15
//---------------------------------------------------------------------
...
void rtw_signal_stat_timer_hdl(struct timer_list *t)                                                    // --- AP ---
{
	struct recv_priv *recvpriv = from_timer(recvpriv, t, signal_stat_timer);                        // --- AP ---
	_adapter *adapter = recvpriv->adapter;                                                          // --- AP ---
#endif //4.15
//--------------------------------------------------------------------
