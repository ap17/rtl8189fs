...
{
	struct pwrctrl_priv *pwrctrlpriv = from_timer(pwrctrlpriv, t, pwr_state_check_timer);                   // --- AP ---
	_adapter *padapter = pwrctrlpriv->padapter;                                                             // --- AP ---
#endif // 4.15
//-------------------------------------------------------------------------
...
//--------------------------------------------------------------------------
	...
	rtw_init_timer(&pwrctrlpriv->pwr_state_check_timer, padapter, pwr_state_check_handler);
#else // 4.15
	pwrctrlpriv->padapter = padapter;                                                                               // --- AP ---
	timer_setup(&pwrctrlpriv->pwr_state_check_timer , pwr_state_check_handler, 0 );                                 // --- AP ---
#endif // 4.15
//--------------------------------------------------------------------------
